...
@section('content')
    <div id="Content-Container"
        ...
        <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
            <a href="{{ route('find-boarding.show', ['slug' => $boardingHouse->slug]) }}"
        ...
        <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
            <div class="flex w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
                ...
                <div class="flex flex-col gap-3 w-full">
                    <h1 class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]">{{ $boardingHouse->name }}
                    </h1>
        ...
        <form action="{{ route('booking', ['slug' => $boardingHouse->slug]) }}" class="relative flex flex-col gap-4 mt-5">
